...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/image/Figure_1.png"),
...
#Picture change Part
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "在电流强度变化的直导线产生的磁场中特定形状线框运动产生电动势"))
        self.label_4.setText(_translate(
            "MainWindow", "注：一些无关常量参数的都设定为简单值，对本例没有本质上的影响"))
    ...
    def change_4(self):
        self.label_3.setPixmap(QtGui.QPixmap(":/image/Rectanglepng.png"))

    def change_5(self):
        self.label_3.setPixmap(QtGui.QPixmap(":/image/Pentagon.png"))

    def change_6(self):
        self.label_3.setPixmap(QtGui.QPixmap(":/image/Hexagon.png"))

    def change_7(self):
        self.label_3.setPixmap(QtGui.QPixmap(":/image/Heptagon.png"))
